    ...
    public static void ListarFechasRiegos() throws ArduinoException {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                switch (OpcionRiego) {
                    case 1:
                        DuracionDelRiego = 5000;
                        break;
                    case 2:
                        DuracionDelRiego = 10000;
                        break;
                    case 3:
                        DuracionDelRiego = 15000;
                        break;
                    case 4:
                        DuracionDelRiego = 20000;
                        break;
                    case 5:
                        DuracionDelRiego = 25000;
                        break;
                    case 6:
                        DuracionDelRiego = 30000;
                        break;
                    case 7:
                        DuracionDelRiego = 35000;
                        break;
                    case 8:
                        DuracionDelRiego = 40000;
                        break;
                    case 9:
                        DuracionDelRiego = 45000;
                        break;
                    case 10:
                        DuracionDelRiego = 50000;
                        break;
                    case 11:
                        DuracionDelRiego = 55000;
                        break;
                }
                if (rs.getString("Fecha_Inicio").equals((Fecha))) {
                    if (Integer.parseInt(HoraRiegoBD) == HoraActual) {
                        if (Integer.parseInt(MinutoRiegoBD) == MinutoActual) {
                            System.out.println("Ejecutando riego");// Agregar notificacion
                            do {
