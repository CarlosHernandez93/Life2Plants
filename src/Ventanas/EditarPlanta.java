...
public class EditarPlanta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTFnombrePlanta.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTFnombrePlantaKeyTyped(evt);
            }
        });
        ...
        jTFcodigo.setBackground(new java.awt.Color(132, 229, 125));
        ...
        jPanel1.add(jTFcodigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 44, 200, 40));

        jButton5.setBackground(new java.awt.Color(132, 229, 125));
        jButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Buscar_1.png"))); // NOI18N
        ...
        jPanel1.add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 40, -1, 50));
    ...
    private void BT_minimizarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BT_minimizarMouseClicked
        this.setState(EditarPlanta.ICONIFIED);
    ...
    private void jTFnombrePlantaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTFnombrePlantaKeyTyped
        char c = evt.getKeyChar();
        if((c<'a' || c>'z') && (c<'A' || c>'Z') && (c<'0' || c>'9')) evt.consume();
    }//GEN-LAST:event_jTFnombrePlantaKeyTyped
