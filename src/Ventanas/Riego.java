...
public class Riego extends javax.swing.JFrame implements Runnable {
    ...
    JDate_DiaInicio.setDateFormatString("");
    JCb_Horas.setSelectedIndex(0);
    JCb_Minutos.setSelectedIndex(0);
    JCb_DuracionRiego.setSelectedIndex(0);
    JCbx_Planta.setSelectedIndex(0);
    ...
    private void initComponents() {
        ...
        JCb_Horas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                JCb_HorasActionPerformed(evt);
            }
        });
        JCb_Horas.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                JCb_HorasPropertyChange(evt);
            }
        });
        ...
        JCb_DuracionRiego.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccione...", "5 Segundos", "10 Segundos", "15 Segundos", "20 Segundos", "25 Segundos", "30 Segundos", "35 Segundos", "40 Segundos", "45 Segundos", "50 Segundos", "55 Segundos" }));
    ...
    private void Jb_ListoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Jb_ListoActionPerformed
        ...
        String fecha = JDate_DiaInicio.getDateFormatString();
        int hora = JCb_Horas.getSelectedIndex();
        int minutos = JCb_Minutos.getSelectedIndex();
        int duracion = JCb_DuracionRiego.getSelectedIndex();
        int planta = JCbx_Planta.getSelectedIndex();
        String descripcion = Jta_Descripcion.getText();
        if((fecha.equals("")) || (hora==0) || (minutos==0) || (duracion==0) || (planta==0) || (descripcion.equals(""))){
    ...
    private void JCb_HorasPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_JCb_HorasPropertyChange
        // TODO add your handling code here:
    }//GEN-LAST:event_JCb_HorasPropertyChange

    private void JCb_HorasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JCb_HorasActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_JCb_HorasActionPerformed
