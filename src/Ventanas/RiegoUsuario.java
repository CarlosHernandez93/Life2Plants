...
import static Ventanas.Riego.JCb_DuracionRiego;
import static Ventanas.Riego.JCb_Horas;
import static Ventanas.Riego.JCb_Minutos;
import static Ventanas.Riego.JCbx_Planta;
import static Ventanas.Riego.Jta_Descripcion;
...
public class RiegoUsuario extends javax.swing.JFrame implements Runnable {
    ...
    private void BT_minimizarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BT_minimizarMouseClicked
        this.setState(RiegoUsuario.ICONIFIED);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            new RiegoUsuario().setVisible(true);
        });
    }
